<template>
    <div class="bg-black bottom-0 left-0 right-0 text-red-500 mb-0 sm:h-40 lg:h-36 flex items-center justify-center flex-row gap-10 sm:text-3xl lg:text-xl">
        <div>
        ...
        <div v-if="isLoggedIn" class="flex flex-col justify-center items-center gap-2">
            ...
            <div class="sec self-center p-2 w-64">
                ...
                <div class="title text-sm text-gray-400 -mt-1">{{Email}}</div>
            </div>
