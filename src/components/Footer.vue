<template>
  <div
    class="bg-black bottom-0 left-0 right-0 text-red-500 mb-0 sm:h-40 lg:h-36 flex items-center justify-center flex-row gap-10 sm:text-3xl lg:text-xl"
  >
    <div>
    ...
    >
      <div class="each flex rounded shadow w-max text-gray-600 bg-white">
        <div class="sec self-center p-2 pr-1">
          <router-link to="/profile" style="text-decoration: none"
            ><img
              data="picture"
              class="w-14 border p-0.5 rounded-full aspect-square object-cover"
              :src="Poza"
              alt="profile-pic"
              v-if="profilePic"
          /></router-link>
      ...
      <router-link to="/surse" class="text-white text-xl underline"
        >Surse</router-link
      >
    </div>
  </div>
