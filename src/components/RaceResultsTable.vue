        ...
        <div class="overflow-x-auto">
          <table class="w-full text-lg lg:text-md text-left text-gray-300">
            ...
            >
              ...
              <td class="px-4 sm:px-6 py-4 font-mono text-gray-300 text-center">
                {{
                  result.completionStatusCode !== "OK"
                      ? result.completionStatusCode
                      : result.positionValue === '1'
                          ? (result.raceTime || result.sprintQualifyingTime)
                          : result.lapsBehindLeader === "0"
                              ? (result.gapToLeader ? "+" + result.gapToLeader + "s" : "—")
                              : (result.lapsBehindLeader ? "+" + result.lapsBehindLeader + " lap" : "—")
                }}
              </td>
