<template>
  ...
  >
    <p class="text-5xl">Sources used:</p>
...
<script setup>
  ...
  useHead({
    title: "GridFanHub | Information page",
    meta: [
      {
        name: "description",
        content:
    ...
    link: [
      {
        rel: "canonical",
        href: "https://gridfanhub.com/info",
      },
    ],
  })
</script>
