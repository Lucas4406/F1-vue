<template>
  <div class="max-w-5xl mx-auto px-6 py-10 text-gray-800 leading-relaxed source">
    ...
    <section class="mb-8">
      <p>
        These Terms of Service ("Terms") govern your access to and use of GridFanHub ("Service").
    ...
    <section class="mb-8">
      <h2 class="text-2xl font-semibold mb-2">Accounts</h2>
      <p>
    ...
    <section class="mb-8">
      ...
      <p>
        ...
        exclusive property of GridFanHub and its licensors.
      </p>
    </section>
    ...
    <section class="mb-8">
      ...
      <p>
        In no event shall GridFanHub, nor its directors, employees, partners, agents, suppliers,
    ...
    <section class="mb-8">
      ...
      <p>
        These Terms shall be governed and construed in accordance with the laws of Romania,
        without regard to its conflict of law provisions.
      </p>
    </section>

    <section class="mb-8">
      <h2 class="text-2xl font-semibold mb-2">Changes</h2>
      <p>
